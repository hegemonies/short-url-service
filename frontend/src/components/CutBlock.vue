...
<template>
  <div class="container">
    <form @submit.prevent="generateURL()" class="mb-4">
    ...
    <p v-if="shortLink">Your short link:
      <a :href="shortLink" target="_blank">{{ shortLink }}</a>
    </p>
    <p v-if="isError" class="text-red-600">Sorry! Network error is occured.</p>
  </div>
</template>
